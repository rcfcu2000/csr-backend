...
func (i *RespCrowdGmvListData) GetData(r ReqCrowdSaAllSearch) error {
	...
	sqlp.SetSql(SQL_CROWD_CrowdGmvList)
	(&r).SetToSQLProccesor(sqlp)
	mainSql := sqlp.GetResult()

	fmt.Println(" SQL_CROWD_CrowdGmvList sql\n", mainSql)
...
func (i *RespCrowdGmvListData) Prodata() {

}

const SQL_CROWD_CrowdGmvList = `
